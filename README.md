...
Виды графов:
<img width="1607" height="790" alt="изображение" src="https://github.com/user-attachments/assets/aa2ce7ef-3234-4efb-b219-a0edc461f38d" />
...
└── README.md  
```
в dev - структура квеста генерируется программно, сюжет генерирует LLM 

в main - структуру квеста и сюжет генерирует LLM
